...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <a class="navbar-brand fw-bold" href="#">Guni Grocery</a>
    ...
    <div class="landing">
        <div class="container">
            <div class="row m-0">
                    <div class="cover">
                        <span class="title">Grocery Items</span>
    ...
    <div class="category">
        <div class="container">
            ...
            <div class="cards">
                <div class="card">
                    <span>
                    <img style="height:50px" src="assets/images/vegitable.png" alt="sdfs">
                ...
                <div class="card">
                    <span>
                    <img style="height:50px" src="assets/images/dairy-products.png" alt="sdfs">
                ...
                <div class="card">
                    <span>
                    <img style="height:50px" src="assets/images/baby-silhouette-sleeping.png" alt="sdfs">
                ...
                <div class="card">
                    <span>
                    <img style="height:50px" src="assets/images/spice-pot.png" alt="sdfs">
                ...
                <div class="card">
                    <span>
                    <img style="height:50px" src="assets/images/household-appliance.png" alt="sdfs">
    ...
    <div class="adver">
        <div class="container">
            <div class="cover">
                <!-- <span class="title">Categories</span> -->
                <span class="desc">Enhance Experience<br />With Feedback</span>
